...
namespace Ipfs.Engine
{
    ...
    public class IpfsEngineTest
    {
        ...
        {
            var ipfs = new IpfsEngine(TestFixture.Passphrase.ToCharArray());
        ...
        {
            var secret = TestFixture.Passphrase;
        ...
        public async Task Wrong_Passphrase()
        {
            ...
            var ipfs2 = new IpfsEngine($"{TestFixture.Passphrase}-wrong".ToCharArray())
            {
