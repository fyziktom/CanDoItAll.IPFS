    ...
    public class FileSystemApiTest
    {
        ...
        public async Task AddFile_Wrap()
        {
            ...
            try
            {
                ...
                Assert.AreEqual("QmYhw8cf5HC5oLRArnwi3H7uc4SATmzY9gkrhVZP6tXQvH", (string)node.Id);
                ...
                Assert.AreEqual(11, node.Links.First().ContentSize);
            }
            finally
            {
                File.Delete(path);
        ...
        public void AddDirectoryRecursive()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(2, files[2].ContentSize);
                Assert.AreEqual(2, files[2].ChildCount);
                ...
                Assert.AreEqual(5, rootFiles[0].ContentSize);
                Assert.AreEqual(4, rootFiles[1].ContentSize);
                Assert.IsTrue(rootFiles[2].IsDirectory);
                Assert.AreEqual(2, rootFiles[2].ContentSize);
                Assert.AreEqual(2, rootFiles[2].ChildCount);
                ...
                Assert.AreEqual(1, xfiles[0].ContentSize);
                Assert.IsTrue(xfiles[1].IsDirectory);
                Assert.AreEqual(1, xfiles[1].ContentSize);
                Assert.AreEqual(1, xfiles[1].ChildCount);
                ...
                Assert.AreEqual(1, yfiles[0].ContentSize);
